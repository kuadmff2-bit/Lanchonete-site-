(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      body.admin-view .admin-product-image{
      ...
      body.admin-view .admin-product-main{
        grid-column:2!important;
        min-width:0!important;
        overflow:hidden!important;
        padding-top:3px!important;
      }
      body.admin-view .admin-product-main strong{
      ...
      body.admin-view .admin-product-main small{
        display:block!important;
        white-space:normal!important;
        overflow-wrap:anywhere!important;
        line-height:1.35!important;
      }
      body.admin-view .admin-product-main .availability{
        max-width:100%!important;
        white-space:normal!important;
        text-align:center!important;
      }
      body.admin-view .product-actions{
      ...
      body.${MODAL_CLASS} #promoV2Form{
        ...
        border:1px solid var(--line,#2c2c2c)!important;
        border-radius:20px!important;
        background:var(--card,#171717)!important;
        box-shadow:0 28px 90px rgba(0,0,0,.65)!important;
      }
      body.${MODAL_CLASS} #promoV2Form .promo-v2-form-grid{
        grid-template-columns:minmax(0,1fr)!important;
        gap:13px!important;
      }
      body.${MODAL_CLASS} #promoV2Form .promo-v2-form-grid .full{
        grid-column:auto!important;
      }
      body.${MODAL_CLASS} #promoV2ImagePreview{
        width:min(100%,330px)!important;
        margin:0 auto!important;
      }
      body.${MODAL_CLASS} #promoV2Live{
        display:none!important;
      }
      body.${MODAL_CLASS} #promoV2Form .promo-v2-toggles{
        display:grid!important;
        grid-template-columns:repeat(2,minmax(0,1fr))!important;
        gap:10px!important;
      }
      body.${MODAL_CLASS} #promoV2Form .promo-v2-toggles label{
        min-width:0!important;
        align-items:flex-start!important;
        line-height:1.35!important;
      }
      body.${MODAL_CLASS} #promoV2Form .promo-v2-form-actions{
        display:grid!important;
        grid-template-columns:repeat(2,minmax(0,1fr))!important;
        gap:10px!important;
      }
      body.${MODAL_CLASS} #promoV2Form input,
      body.${MODAL_CLASS} #promoV2Form textarea,
      body.${MODAL_CLASS} #promoV2Form button{
        max-width:100%!important;
      }
      body.${MODAL_CLASS} .image-editor-backdrop{
      ...
      @media(max-width:850px){
        ...
        body.admin-view .product-actions button{
          min-width:0!important;
          width:100%!important;
        }
      }
  ...
  function installStatusObserver() {
    ...
    const observer = new MutationObserver(() => {
      ...
      if (document.body.classList.contains(MODAL_CLASS) && status.classList.contains("ok") && /promoção atualizada/i.test(text)) {
        closePromoEditor();
      }
    });
  ...
  const timer = setInterval(() => {
    tries += 1;
    const ready = installStatusObserver();
